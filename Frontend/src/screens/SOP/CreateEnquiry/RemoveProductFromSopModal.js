...
function RemoveProductFromSopModal(props) {
    ...
    <>
      ...
      >
        <Modal.Header style={{height:40, border:'none', backgroundColor:'#dc3545', color:'white',}}>
          <Modal.Title style={{ fontSize:16, fontWeight:500}}>Remove Confirmation</Modal.Title>
        </Modal.Header>
        <Modal.Body style={{backgroundColor:'', fontSize:14, padding:30}}>
         Are you sure you want to remove product from SOP ?
        </Modal.Body>
        <Modal.Footer>
          ...
          <Button onClick={props.onAction} style={{backgroundColor:'#dc3545', height:30, width:90, textAlign:'center', padding:0, fontSize:12, fontWeight:600, borderRadius:3, boxShadow:'0px 4px 4px rgba(0, 0, 0, 0.25)', border:'0px', color:'white'}}>Remove</Button>
...
export default RemoveProductFromSopModal